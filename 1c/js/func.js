...
function startAdvantages() {
  if(window.scrollY >= (advScroll.offsetTop - 100) && window.scrollY < reviewsScroll.offsetTop - 300 && !checkScrollY) {
    checkScrollY = true;
