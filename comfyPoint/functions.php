...
function generationlead_styles() {
  ...
  wp_enqueue_style( 'style-libs', get_template_directory_uri() .'/css/libs.min.css',array(),'1');
	wp_enqueue_style( 'style-main', get_template_directory_uri() .'/css/main.css',array(),'1');
  wp_enqueue_style( 'mediaall', get_template_directory_uri() .'/css/mediaall.css',array(),'1');
